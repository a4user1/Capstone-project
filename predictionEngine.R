...
trigramData <- readRDS(file="ShinyApp/data/trigramData.RData")
bigramData <- readRDS(file="ShinyApp/data/bigramData.RData")
unigramData <- readRDS(file="ShinyApp/data/unigramData.RData")
